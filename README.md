...
- Production note: `RUN_MODE` must be set explicitly by the deployment system. The application does not implement a separate Simple Mode confirmation variable.
